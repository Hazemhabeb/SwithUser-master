...
public class OrderPreviewDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data = (PreviewOrder) getIntent().getSerializableExtra("data");
        ...
        equimentTV.setText(data.getEquimentTypeId());

        SimpleDateFormat formatter = new SimpleDateFormat("dd/MM");
        String dateString = formatter.format(new Date(Long.parseLong(data.getTime())));
    ...
    @OnClick(R.id.recieveBtn)void recieveAction(){
        ...
        ref.child("PreviewOrders")
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(OrderPreviewDetailActivity.this, "تم الاستلام بنجاح ", Toast.LENGTH_LONG).show();
                finish();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                // ...
                loading.setVisibility(View.GONE);
                Toast.makeText(OrderPreviewDetailActivity.this, "حدث خطأ برجاء المحاولة مره اخري ", Toast.LENGTH_LONG).show();
                finish();
    ...
    @OnClick(R.id.reportBtn)void reportAction(){
        ...
        Intent i = new Intent(OrderPreviewDetailActivity.this,ContactUsActivity.class);
        i.putExtra("data"," طلب معاينة  رقم "+data.getOrderNumber());
        startActivity(i);
    ...
    @OnClick(R.id.rateBtn)void rateAction(){
        ...
        Intent i = new Intent(OrderPreviewDetailActivity.this, RateActivity.class);
