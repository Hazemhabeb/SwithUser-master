 ...
 */
public class OrderMaintenanceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_maintenance_order, container, false);
    ...
    private void getProduct() {
        ...
        df.child("MaintenanceOrders").orderByChild("userId").equalTo(pref.getUserId()).addValueEventListener(new ValueEventListener() {
            @Override
