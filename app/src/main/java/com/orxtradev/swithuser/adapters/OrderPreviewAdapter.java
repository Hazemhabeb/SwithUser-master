...
public class OrderPreviewAdapter extends RecyclerView.Adapter<OrderPreviewAdapter.ViewHolder> {
    ...
    private ArrayList<PreviewOrder> data;
    public OrderPreviewAdapter(Context context, ArrayList<PreviewOrder> data) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, OrderPreviewDetailActivity.class);
